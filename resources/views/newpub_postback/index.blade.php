...
@section('title', 'Newpub Adpia Affiliate PostBack')
				...
				<div class="x_content">
					<div class="row">
						<div class="col-xs-12">
							...
							@if ($postBackData)
							<a data-toggle="modal" href="#modal-add" class="btn btn-success" style="color: #ffffff !important;">Xem
							PostBack</a>
							@else
							<a data-toggle="modal" href="#modal-add" class="btn btn-success" style="color: #ffffff !important;">Tạo
							PostBack</a>
							@endif
						</div>
					</div>
