	...
	<div class="academy-flex-container">
		...
		<div class="free-100-lession" style="padding: 20px;">
			<div class="free-header">
				...
				<a href="{{ config('const.adpia_youtube') }}" target="_blank"><div class="right-header">Xem toàn bộ danh sách</div></a>
			</div>
		...
		<div class="offline-event-box">
			...
			<div class="free-100-lession">
				<div class="free-header">
					<div class="left-header">BÀI HỌC CƠ BẢN CHO PUBLISHER MỚI BẮT ĐẦU</div>
					<div class="right-header">Khóa học miễn phí 100%</div>
				</div>
				<div class="free-lession-video">
