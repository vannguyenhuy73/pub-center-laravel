...
@section('title', 'Newpub Adpia Affiliate Smart Carousel')
				...
				<div class="x_content">
					...
					<div class="col-md-12 " style="margin-top: 30px;margin-bottom: 30px;">
						...
						<div class=" text-center" style="margin-top: 20px;">
							<iframe width="100%" height="480" src="https://www.youtube.com/embed/8Be7lJfGdiE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	$('#create__link').click(() => {
		...
		m_id = $('#merchant').val();
		$.ajax({
			url : "{{route('newpub.tool.get-carousel')}}",
			method: 'get',
