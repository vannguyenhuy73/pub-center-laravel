...
@section('title', 'Newpub Adpia Affiliate Board')
				...
				<div class="x_content">
					...
					<div class="col-sm-6 col-xs-12">
						<div class="row list-event">
							<div class="col-sm-3">
								<a href="{{ route('newpub.board.show', $board->article_id) }}">
							...
							<div class="col-sm-9">
								...
								<h2>
									<a href="{{ route('newpub.board.show', $board->article_id)  }}">{{ str_limit(strip_tags($board->title),
									30, '...')}}</a>
								</h2>
