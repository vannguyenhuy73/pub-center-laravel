...
$('.mail-list li a').each(function (index, element) {
    // if (element.)
    console.log();
});
...
function showConversionStatus(status) {
...
$('#select-site').change(function () {
    var siteId = $(this).val();
    window.location.href = baseUrl + '/switch-site/' + siteId;
});
